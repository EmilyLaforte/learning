...
from .game_message import Message, MessageLog
...
def main():
    ...
    player = Entity(0, 0, "@" , libtcod.turquoise, "Player", blocks = True,render_order=RenderOrder.ACTOR, fighter = fighter_component,
                    inventory=inventory_component)
    entities = [player]
    libtcod.console_set_custom_font("roguelike/arial10x10.png", libtcod.FONT_TYPE_GREYSCALE | libtcod.FONT_LAYOUT_TCOD)

    libtcod.console_init_root(screen_width, screen_height, "tr**hy rogue like", False)
    ...
    while not libtcod.console_is_window_closed():
        ...
        if move and game_state == GameStates.PLAYERS_TURN:
            ...
            for entity in entities:
                ...
                message_log.add_message(Message("There is no love here to receive", libtcod.lighter_crimson))
